const Footer = () => {
  return (
    <div className="w-full p-6 bg-[#041226] text-white rounded-lg shadow-lg flex flex-col items-center h-[100%]">
      <div className="flex flex-wrap justify-center mb-6">
        <span className="cursor-pointer hover:text-blue-400 mx-2">
          Terms Of Use
        </span>
        <span className="cursor-pointer hover:text-blue-400 mx-2">
          Privacy Policy
